...
def cerimonia(id):
    cerimonia = db.execute(
        """
        SELECT cer.cerimonia_id, cer.ano, ca.categoria, ne.nome, ca.categoria_ano_id
        FROM cerimonia AS cer
        JOIN categoria_ano AS ca ON ca.cerimonia_id = cer.cerimonia_id
        JOIN nomeacao AS n ON n.categoria_ano_id = ca.categoria_ano_id
...
def categoria(id):
    nomeacoes = db.execute(
        """
        SELECT cat.categoria_canonica, ca.categoria, ne.nome, ca.categoria_ano_id, cer.ano, cer.cerimonia_id
        FROM cerimonia as cer
        JOIN categoria_ano as ca on ca.cerimonia_id = cer.cerimonia_id
